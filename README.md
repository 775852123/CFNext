...
## 🐛 BUG 处理
5. **Trojan 协议在 Mihomo/Clash Verge 中延迟失败/不可用，修复后三种协议在Clash Verge均可使用**
5. **修复V2rayNG 使用必须开启软件的**本地 DNS **选项的问题；
5. **更换Mihomo内核下发的配置文件，新配置增加防DNS泄露；
5. 根据现有代码，更新**特别鸣谢/调用 API 接口名单**；
